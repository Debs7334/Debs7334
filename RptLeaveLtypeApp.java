...
import java.sql.*;
class RptLeaveLtypeWin implements ActionListener{
	JFrame f1;
...
public RptLeaveLtypeWin(){
	...
	btnshow.setToolTipText("To Show Leave Application Leave Type wise");
...
public void actionPerformed(ActionEvent ae){
	if(ae.getSource()==btnshow){
		...
		try{
			...
			rsuser=stmtselect.executeQuery("select * from tblleave where ltype='"+type+"'");
			rsuser.last();
			tot=rsuser.getRow();
