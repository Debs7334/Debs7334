...
import java.sql.*;
class RptAttendShftWin implements ActionListener{
	JFrame f1;
...
public RptAttendShftWin(){
	...
	btnshow.setToolTipText("To Show Attendance Register Shift wise");
...
public void actionPerformed(ActionEvent ae){
	if(ae.getSource()==btnshow){
		...
		try{
			...
			rsuser=stmtselect.executeQuery("select * from tblattendance where shnm='"+shft+"'");
			rsuser.last();
			tot=rsuser.getRow();
