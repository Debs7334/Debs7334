...
import java.sql.*;
class RptLeaveDeptWin implements ActionListener{
	JFrame f1;
...
public RptLeaveDeptWin(){
	...
	btnshow.setToolTipText("To Show Leave Application Department wise");
...
public void actionPerformed(ActionEvent ae){
	if(ae.getSource()==btnshow){
		...
		try{
			...
			rsuser=stmtselect.executeQuery("select * from tblleave where dpnm='"+dept+"'");
			rsuser.last();
			tot=rsuser.getRow();
