...
import java.sql.*;
class RptAprShftWin implements ActionListener{
	JFrame f1;
...
public RptAprShftWin(){
	...
	btnshow.setToolTipText("To Show Leave Approval Shift wise");
...
public void actionPerformed(ActionEvent ae){
	if(ae.getSource()==btnshow){
		...
		try{
			...
			rsuser=stmtselect.executeQuery("select * from tblapproval where shnm='"+shft+"'");
			rsuser.last();
			tot=rsuser.getRow();
